...
import os
from langchain.embeddings import HuggingFaceEmbeddings  # Use HuggingFaceEmbeddings as an alternative
...
def user_input(user_question):
    ...
    embeddings = HuggingFaceEmbeddings()  # Use HuggingFaceEmbeddings for consistency
